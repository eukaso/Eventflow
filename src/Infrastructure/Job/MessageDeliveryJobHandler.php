...
final readonly class MessageDeliveryJobHandler implements JobHandler
{
    ...
    public function validatePayload(array $payload):void{if(array_keys($payload)!==['message_id','provider']||!is_int($payload['message_id'])||$payload['message_id']<1||!in_array($payload['provider'],['brevo','twilio'],true))throw new JobException('message_delivery_payload_invalid');}
