...
IMP-076 exposes the privileged audit access contracts through three authenticated, read-only endpoints under `/eventflow/v1/events/{event_id}/audit-logs`: collection, detail, and `/integrity` verification.
